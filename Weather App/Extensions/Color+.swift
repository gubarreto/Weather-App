...
extension Color {
    ...
    static let bottomSheetBorderMiddle = LinearGradient(colors: [.white, .clear, .clear], startPoint: .top, endPoint: .bottom)
    static let bottomSheetBorderTop = LinearGradient(colors: [.white.opacity(0), .white.opacity(0.5), .white.opacity(0)], startPoint: .leading, endPoint: .trailing)
